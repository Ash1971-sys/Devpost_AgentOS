    ...
    <div className="mesh-gradient" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="animate-fade-in-up" style={{ width: "100%", maxWidth: 440, padding: "0 20px" }}>
        ...
        <div className="glass-card" style={{ padding: 32 }}>
          ...
          <button className="btn btn-secondary btn-lg" style={{ width: "100%", marginBottom: 12 }} onClick={() => googleLogin()} disabled={loading}>
          ...
          <button className="btn btn-ghost btn-lg" style={{ width: "100%", border: "1px solid var(--border-primary)" }} onClick={async () => {
            try { setLoading(true); await loginAsGuest(); router.push("/dashboard"); }
            catch (err: unknown) { setError(err instanceof Error ? err.message : "Guest login failed"); setLoading(false); }
          }} disabled={loading}>
